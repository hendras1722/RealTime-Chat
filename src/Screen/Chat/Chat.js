...
class Homescreen extends Component {
    ...
    renderRow = ({ item }) => {
        if (auth.currentUser.uid === auth.currentUser.uid) {
            return (
                <View style={{ marginHorizontal: 10, marginVertical: 5, borderColor: '#FFF', borderWidth: 1, padding: 15, borderRadius: 10, backgroundColor: '#1ebeff73', flexDirection: 'row' }}>
        ...
        } else if (auth.currentUser.uid === !auth.currentUser.uid) {
            return (
                <View style={{ marginHorizontal: 10, marginVertical: 5, borderColor: '#FFF', borderWidth: 1, padding: 15, borderRadius: 10, backgroundColor: '#1ebeff73', flexDirection: 'row' }}>
